...
if (generatePasswords) {
    generatePasswords.addEventListener("click", () => {
        ...
        for (let i = 0; i < currentAmount; i++) {
            ...
            liElement.classList.add("bg-[#141414]", "border", "border-[#90909030]", "max-lg:w-full", "w-[50%]", "text-center", "text-[#909090]", "hover:text-[#5C5C5C]", "duration-150", "cursor-pointer", "font-semibold", "rounded-sm");
